...
const GATED_CHILD_HINTS = {
  ...
  // 查岗那儿是**五个**开关（电脑屏幕 / 手机屏幕 / 查看手机 / 操控手机 / 放歌，
  // 见 labels.js:SPY_SWITCHES）。屏幕那两个只开一条时另一条的标签会被裁掉
  // （server/src/spy.js:trimSpyPrompt），所以这里五个都提
  spy: {
    switch: "电脑查岗 / 手机查岗 / 查看手机里的东西 / 操控手机 / 让角色放歌",
    why: "会把你自己屏幕上的东西抓下来打给视觉模型，还能替你打开 App、动你的手机 —— 五个开关各管一摊，全关的话这一条压根不注入",
  },
};
